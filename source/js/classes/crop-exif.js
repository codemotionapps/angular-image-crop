...
function cropEXIF(){
	...
	const StringValues = this.StringValues = {
		ExposureProgram: {
			0: `Not defined`,
			1: `Manual`,
			2: `Normal program`,
	...
	function readTagValue(file, entryOffset, tiffStart, _, bigEnd){
