cropAreaRectangle.$inject = [`cropArea`];
function cropAreaRectangle(CropArea){
	const CropAreaRectangle = function(){
	...
	CropAreaRectangle.prototype._isCoordWithinArea = function(coord){
		const rectangleDimensions = this._calcRectangleDimensions();
	...
	CropAreaRectangle.prototype._isCoordWithinResizeCtrl = function(coord){
		const resizeIconsCenterCoords = this._calcRectangleCorners();
		let res = -1;
	...
	CropAreaRectangle.prototype._drawArea = function(ctx, _, size){
...
module.exports = cropAreaRectangle;